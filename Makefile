...
build: $(SERVER_FILES) $(CONFIG_FILES) $(STATIC_FILES) $(TOOLS_FILES)

tar: sputnik.tar.gz

sputnik.tar.gz: build
	cd $(BUILD_ROOT); tar --numeric-owner --owner=0 --group=0 -czf ../sputnik.tar.gz *
